...
{
    auto& ene(manager->addEntity());
    ene.addComponent<TransformComponent>(pos.x, pos.y, width, height, 1);
    ene.addComponent<SpriteComponent>(id, idArray, sizeidArray);
    ene.addComponent<Enemy1>(10, id, pos.x, pos.y);
    ene.addComponent<StatusBar>(100, 100, width, id);
    ene.addGroup(Game::groupEnemy);
}
